...
class CreateRoutineP03 extends StatelessWidget {
  const CreateRoutineP03({Key? key}) : super(key: key);
                        ...
                        children: [
                          Column(
                            ...
                            children:  [
                              ...
                              Gap(5),
                              Text("RECOMMEND PHYSICAL ACTIVITIES", style: Styles.headlineStyle4.copyWith(color: Colors.white),)
                            ],
                          ),
                          GestureDetector(
                            onTap: (){
