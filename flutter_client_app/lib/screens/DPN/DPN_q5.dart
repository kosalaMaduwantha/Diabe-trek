...
class dpn_q5 extends StatelessWidget {
  const dpn_q5({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("What is your insulin intake?", style: Styles.headlineStyle2.copyWith(color: Colors.blueGrey,fontSize: 30),),
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const dpn_q6()));
                            },
                          ),
                        ),
