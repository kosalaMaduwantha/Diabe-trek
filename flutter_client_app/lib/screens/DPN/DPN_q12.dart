...
class dpn_q12 extends StatelessWidget {
  const dpn_q12({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("Enter your Urino Micro Albumin result", style: Styles.headlineStyle2.copyWith(color: Colors.blueGrey,fontSize: 30),),
                  ...
                  Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            child: Text('Get My Result', style: TextStyle(fontSize: 20.0),),
                            color: Colors.blueGrey,
                            textColor: Colors.white,
                            onPressed: () {
                              //Navigator.push(context, MaterialPageRoute(builder: (context) =>  dpn_result(content: null,)));
                            },
                          ),
                        ),
