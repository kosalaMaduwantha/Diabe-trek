...
import 'package:diabe_trek/screens/DPN/DPN_q9.dart';
...
class dpn_q8 extends StatelessWidget {
  const dpn_q8({Key? key}) : super(key: key);
            ...
            Container(
              ...
              child: Column(
                children: [
                  Gap(35),
                  Container(
                    child: Text("Is your foot (feet) numb to cotton wool?", style: Styles.headlineStyle1.copyWith(fontSize: 23),),
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: ()  {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const dpn_q9()));
                            },
                          ),
                        ),
