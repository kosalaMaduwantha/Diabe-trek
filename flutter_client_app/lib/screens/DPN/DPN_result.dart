...
import 'DPN_page01.dart';
import 'DPN_q6.dart';
import 'DPN_q7.dart';

class dpn_result extends StatelessWidget {
  final String text;
  const dpn_result({Key? key, required this.text}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("IT IS  ", style: Styles.headlineStyle2.copyWith(color: Colors.blueGrey,fontSize: 30),),
                  ...
                  Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            child: Text('Back to Home Page', style: TextStyle(fontSize: 20.0),),
