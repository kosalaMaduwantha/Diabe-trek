...
class dpn_q7 extends StatelessWidget {
  const dpn_q7({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("What is your age?", style: Styles.headlineStyle2.copyWith(color: Colors.blueGrey,fontSize: 30),),
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const dpn_q8()));
                            },
                          ),
                        ),
