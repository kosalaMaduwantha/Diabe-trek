...
import 'DPN_q1.dart';
import 'dpn_form_bg.dart';

class dpn_start extends StatelessWidget {
  const dpn_start({Key? key}) : super(key: key);
            ...
            Container(
              ...
              child: Column(
                children: [
                  Gap(35),
                  Container(
                    child: Text("Let's answer a few questions!", style: Styles.headlineStyle1.copyWith(fontSize: 23),),
              ...
              Row(
                ...
                Container(
                  ...
                  child: FlatButton(
                      ...
                      textColor: Colors.white,
                       onPressed: ()  {
                         Navigator.push(context, MaterialPageRoute(builder: (context) => const dpnFormScreen()));
                       },
                  ),
                ),
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    textColor: Colors.white,
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const dpn_q1()));
                    },
                  ),
                ),
              ]
