...
class dpn_q4 extends StatelessWidget {
  const dpn_q4({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("What is your current skin thickness?", style: Styles.headlineStyle2.copyWith(color: Colors.blueGrey,fontSize: 30),),
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const dpn_q5()));
                            },
                          ),
                        ),
