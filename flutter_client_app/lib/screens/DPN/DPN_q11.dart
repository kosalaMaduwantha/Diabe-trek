...
class dpn_q11 extends StatelessWidget {
  const dpn_q11({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("Enter your Retinopathy Screening Grading", style: Styles.headlineStyle2.copyWith(color: Colors.blueGrey,fontSize: 30),),
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const dpn_q12()));
                            },
                          ),
                        ),
