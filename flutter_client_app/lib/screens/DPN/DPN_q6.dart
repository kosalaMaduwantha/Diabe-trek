...
class dpn_q6 extends StatelessWidget {
  const dpn_q6({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("What is your BMI?", style: Styles.headlineStyle2.copyWith(color: Colors.blueGrey,fontSize: 30),),
                      ...
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const dpn_q7()));
                            },
                          ),
                        ),
